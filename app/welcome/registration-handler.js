...
class RegistrationHandler {
  ...
  showNextSteps(userType, step) {
    const messages = {
      ...
      tourist: {
        download_app: '🎉 Perfect! You\'ll get an email when VAI launches on July 20th. Get ready to unlock paradise!',
        explore_local: '🌺 Welcome! Discover local experiences starting July 20th when VAI goes live.'
      }, */
      operator: {
